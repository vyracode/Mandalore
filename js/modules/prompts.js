...
MARKDOWN FORMATTING:
- Use **bold** for correct words/characters in explanations
- Use *italic* for incorrect/missing words that need attention
- Use line breaks (\\n) to separate different points in detailed explanations
...
{"words":[{"text":"他","cls":"ok","detail":"Correct! **他 (tā)** = he"},{"text":"是","cls":"ok","detail":"Correct! **是 (shì)** = is"},{"text":"美高","cls":"spelling","detail":"Close! You got **美 (měi)** right, but *高 (gāo)* should be **国 (guó)**, and you're missing *人 (rén)*.\nThe word is **美国人 (měiguórén)**."}],"overview":"Good attempt! 👍 2 out of 3 words correct - **他 (tā)** and **是 (shì)** are perfect!"}
...
{"words":[{"text":"wo","cls":"ok","detail":"Correct! **wo** = **我 (wǒ)**"},{"text":"吃","cls":"missing","detail":"Missing *吃 (chī)*\nDon't skip verbs!"},{"text":"苹果","cls":"ok","detail":"Correct! **苹果 (píngguǒ)** = apple"},{"text":"hello","cls":"extra","detail":"Extra word - *not needed*"}],"overview":"2 out of 3 words correct - got **我 (wǒ)** and **苹果 (píngguǒ)**, but missed *吃 (chī)*. 😊"}
...
{"words":[{"text":"wo","cls":"ok","detail":"Correct! **wo** = **我 (wǒ)**"},{"text":"xihun","cls":"spelling","detail":"Typo! Should be **xihuan** (**喜欢** xǐhuān), not *xihun*"},{"text":"猫","cls":"wrong","detail":"Wrong word! *猫 (māo)* means 'cat', but sentence says 'dogs'\nShould be **狗 (gǒu)**"}],"overview":"Good structure! 🐕 Got **我 (wǒ)** right, but typo in *喜欢 (xǐhuān)* and used *猫 (māo)* instead of **狗 (gǒu)**."}`;
    },
...
MARKDOWN FORMATTING:
- Use **bold** for correctly understood Chinese words in explanations
- Use *italic* for words that were misunderstood or missing
- Use line breaks (\\n) to separate different points in detailed explanations
...
{"words":[{"text":"I","cls":"ok","detail":"Correct! **我** = I"},{"text":"很","cls":"missing","detail":"Missing *很 (very/really)*\nShould be 'I **really** like' or 'I like...a lot'"},{"text":"like","cls":"ok","detail":"Correct! **喜欢** = like"},{"text":"吃","cls":"missing","detail":"Missing *吃 (eat)*\nChinese says 'like **eating**' not just 'like'"},{"text":"apples","cls":"ok","detail":"Correct! **苹果** = apple(s)"}],"overview":"Good start! 👍 But missed some nuance - try 'I **really** like **eating** apples'."}

EXAMPLE 3 (Wrong meaning):
Source: "他是我的朋友"
User: "He is my brother"

{"words":[{"text":"He is","cls":"ok","detail":"Correct! **他是** = He is"},{"text":"my","cls":"ok","detail":"Correct! **我的** = my"},{"text":"brother","cls":"wrong","detail":"Wrong! *朋友* means 'friend', not 'brother'\nShould be **friend** (兄弟 = brother)"}],"overview":"Almost! 😊 Just mixed up *朋友 (friend)* with *兄弟 (brother)*."}

EXAMPLE 4 (English typo - still ok):
Source: "她每天学习中文"
User: "She studys Chineese every day"

{"words":[{"text":"She","cls":"ok","detail":"Correct! **她** = she"},{"text":"studys","cls":"ok","detail":"Correct! **学习** = study\n(btw: *'studies'* in English)"},{"text":"Chineese","cls":"ok","detail":"Correct! **中文** = Chinese\n(btw: spelled *'Chinese'*)"},{"text":"every day","cls":"ok","detail":"Correct! **每天** = every day"}],"overview":"Perfect comprehension! 🎉 You understood everything."}`;
    },
